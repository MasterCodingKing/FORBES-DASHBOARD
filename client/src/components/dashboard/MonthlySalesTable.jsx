    ...
    <div className="bg-white rounded-lg shadow-md p-6" id="monthly-sales-table-export">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Daily breakdown of sales by service category</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-500">
          No sales data available for {months.find(m => m.value === selectedMonth)?.label} {selectedYear}
        </div>
      ) : (
