...
CREATE TABLE IF NOT EXISTS `monthly_targets` (
  ...
  `noi_amount` DECIMAL(20, 2) DEFAULT 0 COMMENT 'Monthly Net Operating Income (manually entered)',
  ...
  CONSTRAINT `chk_noi_amount` CHECK (`noi_amount` >= 0)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
COMMENT='Monthly sales targets and NOI per department';
